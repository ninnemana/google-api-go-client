...
func (c *BucketAccessControlsDeleteCall) Do() error {
	...
	encBucket := strings.Replace(url.QueryEscape(c.bucket), "+", "%20", -1)
	encEntity := strings.Replace(url.QueryEscape(c.entity), "+", "%20", -1)
	req.URL.Path = strings.Replace(req.URL.Path, "{bucket}", encBucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{entity}", encEntity, 1)
...
func (c *BucketAccessControlsInsertCall) Do() (*BucketAccessControl, error) {
	...
	req.URL.Path = strings.Replace(req.URL.Path, "{bucket}", strings.Replace(url.QueryEscape(c.bucket), "+", "%20", -1), 1)
	googleapi.SetOpaque(req.URL)
...
func (c *ObjectAccessControlsDeleteCall) Do() error {
	...
	req, _ := http.NewRequest("DELETE", urls, body)
	encBucket := strings.Replace(url.QueryEscape(c.bucket), "+", "%20", -1)
	encObject := strings.Replace(url.QueryEscape(c.object), "+", "%20", -1)
	encEntity := strings.Replace(url.QueryEscape(c.entity), "+", "%20", -1)
	req.URL.Path = strings.Replace(req.URL.Path, "{bucket}", encBucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{object}", encObject, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{entity}", encEntity, 1)
	googleapi.SetOpaque(req.URL)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
	res, err := c.s.client.Do(req)
...
func (c *ObjectsComposeCall) Do() (*Object, error) {
	...
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	encBucket := strings.Replace(url.QueryEscape(c.destinationBucket), "+", "%20", -1)
	encObject := strings.Replace(url.QueryEscape(c.destinationObject), "+", "%20", -1)
	req.URL.Path = strings.Replace(req.URL.Path, "{destinationBucket}", encBucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{destinationObject}", encObject, 1)
	googleapi.SetOpaque(req.URL)
	req.Header.Set("Content-Type", ctype)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
	res, err := c.s.client.Do(req)
...
func (c *ObjectsCopyCall) Do() (*Object, error) {
	...
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	srcBucket := strings.Replace(url.QueryEscape(c.sourceBucket), "+", "%20", -1)
	srcObject := strings.Replace(url.QueryEscape(c.sourceObject), "+", "%20", -1)
	destBucket := strings.Replace(url.QueryEscape(c.destinationBucket), "+", "%20", -1)
	destObject := strings.Replace(url.QueryEscape(c.destinationObject), "+", "%20", -1)
	req.URL.Path = strings.Replace(req.URL.Path, "{sourceBucket}", srcBucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{sourceObject}", srcObject, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{destinationBucket}", destBucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{destinationObject}", destObject, 1)
	googleapi.SetOpaque(req.URL)
	req.Header.Set("Content-Type", ctype)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
	res, err := c.s.client.Do(req)
...
func (c *ObjectsDeleteCall) Do() error {
	...
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("DELETE", urls, body)
	req.URL.Path = strings.Replace(req.URL.Path, "{bucket}", c.bucket, 1)
	req.URL.Path = strings.Replace(req.URL.Path, "{object}", c.object, 1)
	googleapi.SetOpaque(req.URL)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
	res, err := c.s.client.Do(req)
	if err != nil {
